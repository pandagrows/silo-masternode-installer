...
SEED2NEED_LATEST_RELEASE="https://github.com/pandagrows/seed2need-silo-coin/releases/download/v5.5.0/seed2need-5.6.1-ubuntu18-daemon.zip"
...
function copy_seed2need_binaries(){
  ...
  unzip seed2need-5.6.1-ubuntu18-daemon.zip
